          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-9">
                <h2 class="breadcrumbs-custom-title">CIO’s LATAM - Eventos Presenciales</h2>
                <ul class="breadcrumbs-custom-path">
                  <li><a href="/">Inicio</a></li>
                  <li class="active">CIO’s LATAM - Eventos Presenciales</li>
                </ul>
              </div>
            </div>
          </div>
                      ...
                      <?php 
                          ...
                          foreach ($obj->data as $key => $value) {
                              ...
                              echo '<div class="wow slideInUp">
                                      ...
                                      <div class="post-classic-figure"><a href="cios-presenciales-detalle/'.$value->id.'"><img src="'.$url.'" style="width: 370px; height: 255px;"/></a></div>
                                      <div class="post-classic-caption">
                                          <h4 class="post-classic-title"><a href="cios-presenciales-detalle/'.$value->id.'">'.$value->attributes->titulo.'</a></h4>
