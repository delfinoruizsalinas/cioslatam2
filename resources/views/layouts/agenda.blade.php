...
<html class="wide wow-animation" lang="en">
  ...
  <meta property="og:image" content="https://cioslatam.com/dash/images/cios/trd2h_.webp">
  <meta property="og:image:url" content="https://cioslatam.com/dash/images/cios/trd2h_.webp">
  <meta property="og:image:width" content="300" />
  <meta property="og:image:height" content="300" />

  <link rel="apple-touch-icon" href="https://cioslatam.com/dash/images/cios/trd2h_.webp">
  <meta name="apple-mobile-web-app-title" content="{{ $title }}">
    ...
    <style>
      @media (max-width: 400px) {
        #portada {
            background-image: url(/dash/images/cios/trd2h_.webp) !important;
    ...
    <div class="page">
      ...
      <section id="portada">
        <div class="parallax-content context-dark"> 
            ...
            <img src="/dash/images/cios/trd2h_.webp" alt="CIO's LATAM Technology Retreat 2024 Hotel Las Brisas" class="img-fluid w-100">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-9 text-center wow-outer">
              <div class="wow slideInLeft">
                <h3 class="title-decorate title-decorate-center">Agenda <br>CIO’s LATAM Technology Retreat 2026 <br></h3>
                <p>Huatulco</p>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-4 col-xl-3 order-lg-2 wow-outer">
                <div class="wow slideInRight">
                  <ul class="nav nav-tabs nav-tabs-modern">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-1" data-toggle="tab">3 Septiembre</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-2" data-toggle="tab">4 Septiembre</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-3" data-toggle="tab">5 Septiembre</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-4" data-toggle="tab">6 Septiembre</a></li>
