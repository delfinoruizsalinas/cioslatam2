...
<div class="container wow-outer">
    ...
    <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>CIO’s LATAM.</span><span>  Todos los derechos reservados.</span><span>&nbsp;</span><a href="{{ url('/aviso-de-privacidad') }}">&nbsp;AVISO DE PRIVACIDAD</a></p>
    </div>
</div>
</footer>