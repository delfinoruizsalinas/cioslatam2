          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-9">
                <h2 class="breadcrumbs-custom-title">CIO’s - Shorts</h2>
                <ul class="breadcrumbs-custom-path">
                  <li><a href="/">Inicio</a></li>
                  <li class="active">CIO’s - Shorts</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="wow-outer">
        ...
        <div class="row row-50">
          <?php 
            ...
            $json = file_get_contents($url_site.'/api/shorts?populate=imagen&sort[2]=createdAt%3Adesc');
            ...
            foreach ($obj->data as $key => $value) {
                ...
                if(empty($value->attributes->createdAt)){
                  $fecha = '';
                }else{
                  $fecha =  date("d-m-Y", strtotime($value->attributes->createdAt));                         
                }
                ...
                echo '<div class="col-md-6 col-lg-4"><div class="post-modern"><div class="post-modern-figure"><a href="'.$youtube.'" target="_blank"><img src="'.$url.'" alt="" width="370" height="255"></a></div><div class="post-modern-caption"><p class="post-modern-date"> <span class="icon mdi mdi-calendar"></span> '.$fecha.' <h4 class="post-modern-title"><a href="'.$youtube.'" target="_blank">'.$titulo.'</a></h4></div></div></div>';
              }
